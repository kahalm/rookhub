...
public class CourseControllerTests : IDisposable
{
    ...
    public CourseControllerTests()
    {
        ...
        _controller = new CourseController(TestServices.Course(_db), new CourseStatsService(_db), ReprocessTestHelper.Build(_db), new RecordingReprocessLauncher(), new CourseAuthoringService(_db), new FlashcardMarkService(_db));
    ...
    public async Task RecordResult_LogsStartAndSolveTime()
    {
        ...
        var controller = new CourseController(TestServices.Course(_db, logger), new CourseStatsService(_db), ReprocessTestHelper.Build(_db), new RecordingReprocessLauncher(), new CourseAuthoringService(_db), new FlashcardMarkService(_db)) { ControllerContext = _controller.ControllerContext };
