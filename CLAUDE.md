...
| POST | `/api/admin/book-puzzles/{id}/flag-hints` | Admin | Tipps als „dumm/schlecht" markieren/aufheben `{ flagged }` (Review-Flag `BookPuzzle.HintsFlagged` fürs gezielte Neu-Generieren; 404 wenn Puzzle fehlt) |
