...
- **Aktuelle Version**: `0.52.0` (Statistik „Alle" zeigt Kurve je Modus; „Analysieren"-Button bei Puzzles; Puzzle-Aufgeben spielt Lösung durch; User-Statistikseite; Analysemodus; Frontend mehrsprachig en/de/hr)
