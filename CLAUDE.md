...
- **Aktuelle Version**: `0.51.0` („Analysieren"-Button bei Puzzles; Puzzle-Aufgeben spielt Lösung durch; User-Statistikseite; Analysemodus; Frontend mehrsprachig en/de/hr)
