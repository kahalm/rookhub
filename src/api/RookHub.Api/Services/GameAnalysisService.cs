...
public class GameAnalysisService
{
    ...
    {
        var remaining = await _db.GameAnalysisPositions
            .CountAsync(p => p.CandidatesJson == null
                && p.GameAnalysis!.UserId == userId
                && (p.GameAnalysis.Status == GameAnalysisStatus.Pending
