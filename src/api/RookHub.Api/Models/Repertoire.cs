...
public class Repertoire
{
    ...
    /// <see cref="RepertoireFile.PgnContent"/> und werten live aus — es gibt keine abgeleiteten Daten
    /// zu erneuern. Ein veraltetes Chessable-Repertoire mit <c>[ChessableOid]</c> bekommt beim
    /// „Aktualisieren" die Zugtexte seiner Linien aus dem Linien-Cache, siehe
    /// <see cref="Services.StaleContentRule.ActionForRepertoire"/>.)
    /// </summary>
