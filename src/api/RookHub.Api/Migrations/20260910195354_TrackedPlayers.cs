...
{
    /// <inheritdoc />
    public partial class TrackedPlayers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrackedPlayers_AppUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackedPlayers_UserId_PlayerKey",
                table: "TrackedPlayers",
                columns: new[] { "UserId", "PlayerKey" },
                unique: true);
        }
